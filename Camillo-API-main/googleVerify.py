...
def google_verification(url):
    try:
        api_key = os.getenv("GOOGLE_SAFE_BROWSING_API_KEY", "AIzaSyDWghaC4_rBMWvhZXNEqID2BexP62DMWM4")  # Retrieve API key from environment variable
        api_url = os.getenv("GOOGLE_SAFE_BROWSING_API_URL", "https://safebrowsing.googleapis.com/v4")  # Retrieve API URL from environment variable
